...
//   - Nav lista só as telas que já existem nesta reconstrução (Dashboard,
//     Movimentos, Relatórios, Logs, Configurações locais ainda não foram
//     portados — ver task própria).
