...
//   - Nav lista só as telas que já existem nesta reconstrução. Movimentos
//     (Performance), Relatórios, Logs e Configurações locais ainda não
//     foram portados — ver task própria.
