...
export default function GovernantaView({ role, podeOperar }: { role: string; podeOperar: boolean }) {
  ...
  // Precisar de material/serviço externo não é mais perguntado aqui — mesmo
  // motivo da Camareira (ver comentário lá): quem classifica é o perfil
  // Manutenção, na coluna "A Processar".
