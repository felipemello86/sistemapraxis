...
// companyId→tenantId; removido `relationLoadStrategy: "join"` (preview
// feature não habilitada no schema compartilhado — mesmo motivo documentado
// em tratamento/page.tsx). Nada aqui referencia Property/UH.
