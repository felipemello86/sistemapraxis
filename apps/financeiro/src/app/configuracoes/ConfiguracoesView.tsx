...
// "essa estrutura de DRE - categorias, super-categorias e relações de soma e
// subtração devem ser customizáveis... criar, editar, mover e subtrair
// todos os campos". Os 4 totais finais da DRE (Margem Bruta / Despesas /
// Geração de Caixa / Lucro-Prejuízo) continuam com esses nomes fixos —
// decisão explícita dele — mas a COMPOSIÇÃO é 100% editável aqui: quais
// blocos (super-categorias) entram em cada total, com que sinal, e quais
// categorias vivem em cada bloco.
...
export function ConfiguracoesView() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-lg font-bold text-gray-900">Configurações da DRE</h1>
