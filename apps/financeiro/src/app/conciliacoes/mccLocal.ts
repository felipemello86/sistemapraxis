// Cópia local de descricaoMcc/MCC_DESCRICOES (fonte: packages/core/src/finance/mcc.ts)
// — mesmo motivo de normalizarTextoLocal em ConciliacoesView.tsx: este é
// um "use client" (ConciliacaoDetalhe.tsx é renderizado dentro dele) e não
// pode fazer import de VALOR de "@praxis/core" (nem de um caminho profundo
// tipo "@praxis/core/finance/mcc" — testado, o pacote não tem "exports"
// configurado pra habilitar subpath imports com moduleResolution
// "bundler"), porque o índice raiz do pacote reexporta
// adminSession.ts/session.ts (que usam next/headers) e quebra o build.
// Mantenha isto em sincronia manual com o original se o mapeamento mudar.
