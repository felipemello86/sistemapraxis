...
// ficam centralizados no gateway); header mobile fixo com
// env(safe-area-inset-top) pro notch/status bar do app nativo.

const MARK_SRC = "/financeiro/praxis-mark.png";
...
// Slug deste próprio app — pra não listar "Financeiro" entre as opções de
// troca (a pessoa já está aqui). Mesmo valor do BASE_PATH de lib/apiFetch.ts.
const MODULO_ATUAL_SLUG = "financeiro";
...
const SIDEBAR_COLLAPSED_KEY = "praxis-financeiro-sidebar-collapsed";
      ...
      <div className="p-5 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-gray-400 text-xs">Financeiro</p>
          </div>
        </div>
        {onClose && (
