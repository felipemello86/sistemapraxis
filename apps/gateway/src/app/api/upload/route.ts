...
// Upload assinado direto pro Cloudinary, mesmo padrão de
// apps/housekeeping/src/app/api/upload/route.ts. Usado hoje só pela foto de
// perfil de usuário (Cadastro de Usuários), por isso o fallback de pasta é
// "usuarios/perfis" em vez de "governanca/perfis" — o gateway atende todos
// os módulos, não só Governança.
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const folder = pasta ? `usuarios/${pasta}` : "usuarios/perfis";
